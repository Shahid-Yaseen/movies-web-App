...
export function LoginForm({login,setLogin}){
     

    return(
      <>
      {
        login?  <section class="bg-gray-50 dark:bg-gray-900">
        ...
        <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
           ...
           setLogin(false)
        }}class="font-medium text-primary-600 hover:underline dark:text-primary-500">Login here</Link>
                    </p>
                </form>
            </div>
        </div>
